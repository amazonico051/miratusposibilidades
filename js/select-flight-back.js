...
class UIFlights{
    ...
    <div class="d-flex align-items-end flex-column">
        ...
        <p class="m-0 fs-4 tc-deep-blue">COP 148.000,00</p>
    </div>
</div>
    ...
    <p class="fs-3 fw-bolder tc-ocean m-0">COP 148.000,00</p>
    ...
    <a class="fw-lighter tc-blue mt-4" href="#">Más detalles</a>
                                ...
                                <div id="light-seat">
                                    ...
                                    <div class="d-flex flex-column align-items-center">
    <p class="fs-3 fw-bolder tc-ocean m-0">COP 183.000,00</p>
    <p class="fs-5 mt-0 mb-5 tc-gray-smoke">Por pasajero</p>
    <a class="fw-lighter tc-blue mt-4" href="#">Más detalles</a>
</div>
                                ...
                                <div id="full-seat">
                                    ...
                                    <div class="d-flex flex-column align-items-center">
    <p class="fs-3 fw-bolder tc-ocean m-0">COP 221.000,00</p>
    <p class="fs-5 mt-0 mb-5 tc-gray-smoke">Por pasajero</p>
    <a class="fw-lighter tc-blue mt-4" href="#">Más detalles</a>
</div>
